...
- Add info to README that without using the custom syntax, certain functionality such as _pretty output_ (colorful, good error messages, ...) will not come out of the box
